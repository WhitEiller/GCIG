...
# 对微调的5个 Qwen2.5 模型进行 HotpotQA 评测并将结果写入txt文件

BASE_DIR="/mnt/disk/yh24/test1/nayak-aclfindings24-code"
MODEL_PATH="/mnt/disk/yh24/test1/qwen2.5/Qwen2.5-7B-Instruct"
OUTPUT_BASE_DIR="${BASE_DIR}/output"
RESULTS_DIR="${BASE_DIR}/results/qwen2.5_models_eval"
RESULTS_FILE="${RESULTS_DIR}/qwen2.5_evaluation_results_summary.txt"
...
# 模型目录名称数组
MODEL_DIRS=(
    "qwen2.5_question_outputs_mode1_sft"
    "qwen2.5_question_outputs_mode2_sft"
    "qwen2.5_question_outputs_mode3_sft"
    "qwen2.5_question_outputs_mode4_sft"
    "qwen2.5_synthetic_results_clean_sorted_top6000"
)

# 初始化结果文件
echo "======================================" > ${RESULTS_FILE}
echo "HotpotQA 评测结果汇总" >> ${RESULTS_FILE}
